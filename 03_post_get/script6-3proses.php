...
<body>
    ...
    <?php
        ...
        $totalDetik1 = $jam1 * 3600 + $menit1 * 60 + $detik1;  // total detik waktu 1
        $totalDetik2 = $jam2 * 3600 + $menit2 * 60 + $detik2;  // total detik waktu 2

        $selisih = $totalDetik1 - $totalDetik2;  // selisih detik kedua waktu
